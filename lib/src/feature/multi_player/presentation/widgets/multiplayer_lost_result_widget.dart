...
class MultiplayerLostResultWidget extends StatelessWidget {
  const MultiplayerLostResultWidget({super.key});
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        "Azimjon",
                        style: AppTextStyle().titleMedium?.copyWith(color: AppColors.c2ED334, fontSize: 24.sp),
                      ),
                      Text(
                        '20',
                        style: AppTextStyle().titleMedium?.copyWith(color: AppColors.c2ED334, fontSize: 24.sp),
