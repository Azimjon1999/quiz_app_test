...
class MultiplayerWinResultWidget extends StatelessWidget {
  const MultiplayerWinResultWidget({super.key});
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        "Azimjon",
                        style: const AppTextStyle().titleMedium?.copyWith(color: AppColors.cFE3340, fontSize: 24.sp),
                      ),
                      Text(
                        '0',
                        style: const AppTextStyle().titleMedium?.copyWith(color: AppColors.cFE3340, fontSize: 24.sp),
